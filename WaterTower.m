function [ ] = WaterTower( Waterlevel, Min_on, Max_off, Rate_in, Rate_out )
...
Pump_status = false;
for a = 2:1:721    % 1440 min/day every 2 min = 720 cycles/iterations
...
hold on
plot(t,Waterlevel,'k-');
plot(t,ones(size(t))*Max_off,'r-'); refline(0,Min_on);
hold off
